...
$image = JURI::base().'components/com_virtuemart/assets/images/vmgeneral/search.png' ;
			...
			if ($button) :
			    if ($imagebutton) :
			        ...
			        $button = '<div class="submit_wrp"><div class="submit_hid"></div><input type="submit" value="'.$button_text.'" class="button'.$moduleclass_sfx.'" onclick="this.form.keyword.focus();"/></div>';
			    endif;
